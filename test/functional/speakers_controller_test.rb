...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, email: @speaker.email, name: @speaker.name, id: @speaker.id, website: @speaker.website }
    end
  ...
  test "should update speaker" do
    put :update, id: @speaker, speaker: { bio: @speaker.bio, email: @speaker.email, name: @speaker.name, id: @speaker.id, website: @speaker.website }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
